...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pluginList.setGeometry(QtCore.QRect(10, 10, 771, 391))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        __sortingEnabled = self.pluginList.isSortingEnabled()
        self.pluginList.setSortingEnabled(False)
        item = self.pluginList.item(0)
        item.setText(_translate("MainWindow", "新建项目"))
        self.pluginList.setSortingEnabled(__sortingEnabled)
