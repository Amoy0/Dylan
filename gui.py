...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 802, 450))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.regularlist.setGeometry(QtCore.QRect(10, 10, 771, 391))
        ...
        self.CQ_console = QtWebEngineWidgets.QWebEngineView(self.Bot)
        self.CQ_console.setGeometry(QtCore.QRect(180, 16, 601, 384))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(10)
        self.CQ_console.setFont(font)
        self.CQ_console.setObjectName("CQ_console")
        self.CQ_states = QtWidgets.QGroupBox(self.Bot)
        self.CQ_states.setGeometry(QtCore.QRect(10, 10, 151, 391))
        self.CQ_states.setObjectName("CQ_states")
        self.CQ_start = QtWidgets.QPushButton(self.CQ_states)
        self.CQ_start.setGeometry(QtCore.QRect(20, 300, 111, 31))
        self.CQ_start.setObjectName("CQ_start")
        self.CQ_stop = QtWidgets.QPushButton(self.CQ_states)
        self.CQ_stop.setGeometry(QtCore.QRect(20, 340, 111, 31))
        self.CQ_stop.setObjectName("CQ_stop")
        ...
        self.setting_scrollArea.setGeometry(QtCore.QRect(0, 0, 796, 450))
        ...
        self.setting_scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 800, 680))
        ...
        self.setting_start.setGeometry(QtCore.QRect(10, 10, 761, 121))
        ...
        self.setting_compatibilityMode = QtWidgets.QCheckBox(self.setting_start)
        self.setting_compatibilityMode.setGeometry(QtCore.QRect(20, 70, 481, 21))
        self.setting_compatibilityMode.setObjectName("setting_compatibilityMode")
        self.setting_autoRestart = QtWidgets.QCheckBox(self.setting_start)
        self.setting_autoRestart.setGeometry(QtCore.QRect(20, 90, 161, 16))
        ...
        self.setting_bot.setGeometry(QtCore.QRect(10, 240, 761, 91))
        ...
        self.setting_sendPort.setGeometry(QtCore.QRect(70, 30, 71, 22))
        ...
        self.setting_listenPort.setGeometry(QtCore.QRect(70, 60, 71, 22))
        ...
        self.setting_botFilepath.setGeometry(QtCore.QRect(180, 50, 481, 21))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(10)
        ...
        self.setting_botFile.setGeometry(QtCore.QRect(180, 30, 71, 16))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(10)
        ...
        self.setting_console.setGeometry(QtCore.QRect(10, 140, 761, 91))
        ...
        self.setting_enableAutoScroll = QtWidgets.QCheckBox(self.setting_console)
        self.setting_enableAutoScroll.setGeometry(QtCore.QRect(220, 50, 181, 16))
        self.setting_enableAutoScroll.setObjectName("setting_enableAutoScroll")
        self.setting_msg = QtWidgets.QGroupBox(self.setting_scrollAreaWidgetContents)
        self.setting_msg.setGeometry(QtCore.QRect(10, 340, 761, 171))
        ...
        self.setting_outputMsgToLog = QtWidgets.QCheckBox(self.setting_msg)
        self.setting_outputMsgToLog.setGeometry(QtCore.QRect(520, 70, 171, 16))
        self.setting_outputMsgToLog.setObjectName("setting_outputMsgToLog")
        self.setting_dylan = QtWidgets.QGroupBox(self.setting_scrollAreaWidgetContents)
        self.setting_dylan.setGeometry(QtCore.QRect(10, 520, 761, 131))
        ...
        self.setting_clearLogs = QtWidgets.QPushButton(self.setting_dylan)
        self.setting_clearLogs.setGeometry(QtCore.QRect(210, 80, 61, 31))
        self.setting_clearLogs.setObjectName("setting_clearLogs")
        ...
        self.setting_state.setGeometry(QtCore.QRect(210, 40, 61, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CQ_states.setTitle(_translate("MainWindow", "状态"))
        self.CQ_start.setText(_translate("MainWindow", "启动"))
        self.CQ_stop.setText(_translate("MainWindow", "停止"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Bot), _translate("MainWindow", "cqhttp"))
        ...
        self.setting_compatibilityMode.setText(_translate("MainWindow", "兼容启动模式（使用嵌套批处理文件开服 若出现服务器启动失败可尝试开启此选项）"))
        ...
        self.setting_enableAutoScroll.setText(_translate("MainWindow", "自动滚动至末尾"))
        ...
        self.setting_outputMsgToLog.setText(_translate("MainWindow", "保存消息记录到日志"))
        self.setting_dylan.setTitle(_translate("MainWindow", "Dylan"))
        self.setting_enableUpdate.setText(_translate("MainWindow", "新版本更新提示"))
        ...
        self.setting_clearLogs.setText(_translate("MainWindow", "清空缓存"))
