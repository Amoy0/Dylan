...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(850, 490)
        Form.setMinimumSize(QtCore.QSize(680, 490))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(10)
        Form.setFont(font)
        self.gridLayout_2 = QtWidgets.QGridLayout(Form)
        self.gridLayout_2.setContentsMargins(-1, 7, -1, -1)
        ...
        self.timedTaskList.setColumnCount(5)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.timedTaskList.setHorizontalHeaderItem(4, item)
        ...
        self.timedTask_state = QtWidgets.QLabel(self.timedTask)
        self.timedTask_state.setObjectName("timedTask_state")
        self.gridLayout_5.addWidget(self.timedTask_state, 1, 0, 1, 1)
        ...
        self.setting_scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 791, 721))
        ...
        self.setting_logout.setMinimumSize(QtCore.QSize(0, 23))
        self.setting_logout.setMaximumSize(QtCore.QSize(16777215, 23))
        ...
        self.setting_ports.setMinimumSize(QtCore.QSize(154, 98))
        ...
        self.setting_savePort.setGeometry(QtCore.QRect(10, 76, 131, 23))
        self.setting_savePort.setMinimumSize(QtCore.QSize(0, 23))
        self.setting_savePort.setMaximumSize(QtCore.QSize(16777215, 23))
        ...
        self.setting_console.setMinimumSize(QtCore.QSize(0, 88))
        self.setting_console.setObjectName("setting_console")
        self.setting_color_style = QtWidgets.QLabel(self.setting_console)
        self.setting_color_style.setGeometry(QtCore.QRect(16, 30, 78, 16))
        ...
        self.setting_enableOutputToLog.setGeometry(QtCore.QRect(200, 30, 114, 17))
        ...
        self.setting_colorfulLogOut.setGeometry(QtCore.QRect(16, 50, 160, 20))
        ...
        self.setting_outputCommandToConsole.setGeometry(QtCore.QRect(200, 50, 166, 17))
    ...
    def retranslateUi(self, Form):
        ...
        item = self.timedTaskList.horizontalHeaderItem(4)
        item.setText(_translate("Form", "执行命令"))
        self.timedTask_state.setText(_translate("Form", "误差时间：-"))
        ...
        self.setting_savePort.setText(_translate("Form", "保存并应用端口"))
        ...
        self.setting_chosenTheme.setItemText(3, _translate("Form", "亚克力（Beta）"))
        self.setting_chosenTheme.setItemText(4, _translate("Form", "Win7"))
        ...
        self.about_logo.setText(_translate("Form", "Dylan"))
