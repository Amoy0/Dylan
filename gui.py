...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.setting_compatibilityMode.setEnabled(False)
        ...
        self.setting_autoRestart.setEnabled(False)
        ...
        self.setting_clearLogs.setEnabled(False)
        self.setting_clearLogs.setGeometry(QtCore.QRect(210, 80, 61, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.setting_clearLogs.setFont(font)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.setting_outputCommandToConsole.setText(_translate("MainWindow", "输出执行的命令输出到控制台"))
        ...
        self.setting_clearLogs.setText(_translate("MainWindow", "重置设置"))
